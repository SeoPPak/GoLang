...
// JWTer의 GenerateToken 메서드를 테스트하는 함수
func TestJWTer_GenJWT(t *testing.T) {
	...
	//Store의 Mock 객체 생성 및 Save 메서드의 Mock 구현
	moq := &StoreMock{}
...
// JWTer의 GetToken 메서드를 테스트하는 함수(성공 케이스)
...
// JWTer의 GetToken 메서드를 테스트하는 함수(실패 케이스)
